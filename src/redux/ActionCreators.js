...
//post comment to the server and get new comment with it's id
export const postFeedback= (firstname, lastname, telnum, email,agree,contactType,message) => (dispatch) => { //postea un feedback. 
  const newFeedback = {
    firstname: firstname,
    lastname: lastname,
    telnum: telnum,
...
newFeedback.date = new Date().toISOString(); //agrega campo fecha con la fecha de hoy
...
console.log(newFeedback);
  ...
  return fetch(baseUrl + 'feedback', {
    ...
    .then(response=>response.json())
    .then(feedback=>dispatch(feedbackPosted(feedback))) 
